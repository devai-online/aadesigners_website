        ...
        <div ref={ref} className={`transition-all duration-1000 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="mb-20">
            ...
            <p className="text-xl text-gray-700 max-w-4xl leading-relaxed">
              ...
              From initial research to final supervision, we guide you through every step of the design process.
            </p>
          </div>
          ...
          <div className="mt-32">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="bg-white rounded-2xl p-8 border-l-4 border-black">
                  <h3 className="text-xl font-bold text-black mb-4">
                    Collaborative Approach
                  </h3>
                  <p className="text-gray-700 leading-relaxed">
                    We work closely with our clients throughout every phase, ensuring your vision 
                    is realized while maintaining the highest standards of design excellence.
                  </p>
                </div>
                ...
                <div className="bg-black text-white rounded-2xl p-8">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Every project undergoes rigorous quality checks at each stage, from initial 
                    concept to final execution, ensuring exceptional results every time.
                  </p>
                </div>
